...
Analytics leverages open source data and R libraries such as [leaflet](https://cran.r-project.org/web/packages/leaflet/index.html) for interactive maps and [plotly in R](https://plotly.com/r/) for other interactive visualisations.
